      ...
      <div class="row" style="padding-top: 2%;">
          ...
          <div class="col">
            <ul class="list-group list-group-flush" style="padding-right: 20%;">
                <li class="list-group-item dados" style="font-weight: 1000; font-size: 40px;">FLOCOS</li>
                <li class="list-group-item dados">2 Anos</li>
                <li class="list-group-item dados">Castrado</li>
                <li class="list-group-item dados">Siamês</li>
              </ul>
        </div>
