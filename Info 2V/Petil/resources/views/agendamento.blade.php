  ...
  <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        ...
        <li><a class="nav-link scrollto active" href="{{ route ('index') }}"><img src="assets/img/homeclaro.png" alt=""></a></li>
            ...
            <li>
                <a class="nav-link scrollto" href="{{ route ('agendamento') }}"><img src="assets/img/cruzescura.png" alt=""></a>
            </li>
            <li>
...
<!-- End Header -->
  ...
  <main id="main" style="padding-top: 70px; padding-bottom:70px;">
    <div class="container" style="width: 70%; height:auto;" id="box">
      <div class="row">
        <h1 class="text-center" style="font-family: Blogger; padding-top: 20px; color:#D66483;">AGENDAMENTOS</h1>
        <div class="col align-text-cter" id="calendario" style="padding-bottom: 24px;">
          <input type="date" class="input-pink input-group-text">
        </div>
        <div class="col" id="opcoes">
          <div class="input-group mb-3">
            <label class="input-group-text input-pink" for="inputGroupSelect01">Tipo</label>
            <select class="form-select input-pink" id="inputGroupSelect01">
          ...
          <div class="input-group mb-3 pt-4">
            <label class="input-group-text input-pink" for="inputGroupSelect02">Horário</label>
            <select class="form-select input-pink" id="inputGroupSelect02">
          ...
          <div class="input-group mb-3 pt-4">
            <label class="input-group-text input-pink" for="inputGroupSelect03">Pet</label>
            <select class="form-select input-pink" id="inputGroupSelect03">
...
<button class="text-center" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal1" style="border: none; background: none; width: 60px; height: 50px;">
