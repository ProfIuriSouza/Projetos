...
<main id="main" style="padding-top: 70px; padding-bottom:70px;">
    <div class="container" style="width: 70%; height:auto;" id="box">
      <div class="row" style="padding-top: 2%;">
          ...
          <div class="col">
            <ul class="list-group list-group-flush" style="padding-right: 20%;">
                <li class="list-group-item dados" style="font-weight: 1000; font-size: 40px;">CAFEZINHO</li>
                <li class="list-group-item dados">5 Anos</li>
                <li class="list-group-item dados">Castrado</li>
                <li class="list-group-item dados">Laranja</li>
              </ul>
        </div>
        <div class="row" style="padding-bottom: 5%; padding-top: 5%;">
            <div class="col">
                <ul class="list-group">
                    <li class="list-group-item" style="background-color: #D66483; color: #fff;">Histórico</li>
                    <li class="list-group-item">Tosa - 01/11/2023</li>
                    <li class="list-group-item">Atendimento clínico - 24/10/2023</li>
                    <li class="list-group-item">Exame laboratorial - 15/09/2023</li>
                    <li class="list-group-item">Tosa - 28/07/2023</li>
                </ul>
            </div>
                    
            <div class="col">
                <ul class="list-group">
                    <li class="list-group-item" style="background-color: #D66483; color: #fff;">Vacinas</li>
                    <li class="list-group-item">Antirrábica - 2023</li>
                    <li class="list-group-item">V3 - 2022</li>
                    <li class="list-group-item">Gripe felina - 2022</li>
                    <li class="list-group-item">V4 - 2022</li>
                </ul>
            </div>
        </div>
